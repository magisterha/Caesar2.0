        ...
        orationes: [
            {
                ...
                analysis_syntacticus: {
                    es: {
                        ...
                        contentus: `<p>La <b>cláusula principal</b> es "<i>Gallia est omnis divisa in partes tres</i>". A esta se subordina una <b>cláusula de relativo</b> introducida por "<i>quarum</i>", que se divide en tres segmentos paralelos y elípticos.</p>`
                    },
                    en: {
                        titulus: "Syntactic Analysis",
                        contentus: `<p>The <b>main clause</b> is "<i>Gallia est omnis divisa in partes tres</i>." A <b>relative clause</b> introduced by "<i>quarum</i>" is subordinated to it, which is divided into three parallel and elliptical segments.</p>`
                    },
                    zh: {
                        titulus: "句法分析",
                        contentus: `<p><b>主句</b>是「<i>Gallia est omnis divisa in partes tres</i>」。其下是一個由「<i>quarum</i>」引導的<b>關係子句</b>，該子句分為三個平行且省略的段落。</p>`
                    }
                },
                translationes_explicatae: {
                    es: {
                        titulus: "Traducción y Comentarios",
                        contentus: `<p><b>Traducción Idiomática:</b><br><i>Toda la Galia está dividida en tres partes: una la habitan los belgas, otra los aquitanos, y la tercera aquellos que en su propia lengua se llaman celtas y en la nuestra, galos.</i></p>`
                    },
                    en: {
                        titulus: "Translations & Commentary",
                        contentus: `<p><b>Idiomatic Translation:</b><br><i>All Gaul is divided into three parts, one of which the Belgae inhabit, another the Aquitani, and the third, those who in their own language are called Celts, in ours, Gauls.</i></p>`
                    },
                    zh: {
                        titulus: "翻譯與註釋",
                        contentus: `<p><b>意譯/文學翻譯：</b><br><i>整個高盧分為三個部分：其中一部分由貝爾格人居住，另一部分由阿奎坦尼人居住，第三部分則是那些在自己語言中稱為凱爾特人、在我們的語言中稱為高盧人的民族。</i></p>`
                    }
                },
                verba: [
            ...
            },
            {
                ...
                verba: [
                     ...
                     { is_ver bi: 'v19_33', terminus: 'confirmat.', analysis_morphologicus: 'Verbo, 3ª pers. sing., presente, activo, indicativo.', analysis_morphologicus_en: 'Verb, 3rd pers. sing., present, active, indicative.', analysis_morphologicus_zh: '動詞，第三人稱單數，現在時，主動語態，直陳法。' }
                ]
            },
            { 
                    id_orationis: 'o20',
                    ...
                    translationes_explicatae: {
                        es: { titulus: "Traducciones y Comentarios", contentus: `<p><b>Traducción Idiomática:</b><br><i>Persuadidos por este discurso, se dan entre sí juramento de lealtad y, una vez tomados sus reinos, esperan poder apoderarse de toda la Galia a través de estos tres pueblos, los más poderosos y firmes.</i></p>` },
